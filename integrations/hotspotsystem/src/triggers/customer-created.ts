...
export let customerCreated = SlateTrigger.create(spec, {
  name: 'Customer Created',
  key: 'customer_created',
  description:
    'Triggered when a new customer registers at a hotspot location. Configure the webhook in the HotspotSystem Control Center under Tools & Settings > Webhooks with the event type "customer.create".'
})
  .input(
    z.object({
