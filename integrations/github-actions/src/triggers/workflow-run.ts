...
export let workflowRunTrigger = SlateTrigger.create(spec, {
  ...
  key: 'workflow_run',
  description:
    'Triggered when a GitHub Actions workflow run is requested, starts, or completes. Provides run status, conclusion, and associated metadata.'
})
  .input(
    z.object({
