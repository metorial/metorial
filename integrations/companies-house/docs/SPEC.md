...
5. The response MIME type must match the requested allowlisted type. Generic octet-stream responses are treated as the requested type; other mismatches are rejected.
