# <img src="logo.svg" height="20"> Google Cloud Vision
...
New connections request `cloud-vision`. Tool gates retain provider-supported legacy grants for existing connections.
